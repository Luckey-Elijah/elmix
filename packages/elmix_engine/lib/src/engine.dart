...
class ElmixEngine {
  ...
  /// Authenticates one Auth Record by email and password.
  ///
  /// Authentication is not a public collection list operation, so it bypasses
  /// collection list access rules while still running authentication hooks.
